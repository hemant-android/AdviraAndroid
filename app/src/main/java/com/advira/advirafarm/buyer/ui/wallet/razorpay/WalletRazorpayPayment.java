...
public class WalletRazorpayPayment  extends Activity implements PaymentResultWithDataListener {

    private static final String TAG = WalletRazorpayPayment.class.getSimpleName();
    String name = "";
    String cardNumber = "";
    String cvv = "";
    String month = "";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = WalletRazorpayPayment.this;
        ...
        Log.e(TAG, "onCreate: MRPP"+userId+"---"+grandtotal);
    ...
    private void netbankinglist() {
        LayoutInflater.from(WalletRazorpayPayment.this).inflate(R.layout.fragment_method_netbanking_wallet_list, frameLayout, true);
        ...
        razorpay.isValidVpa(name, new ValidateVpaCallback() {
            ...
            public void onResponse(boolean b) {
                if (b) {
                    ...
                    Singleton.getInstance().showErrorLongToast(WalletRazorpayPayment.this, "VPA is Not valid");
            ...
            public void onFailure() {
                Singleton.getInstance().showErrorLongToast(WalletRazorpayPayment.this, "Error in validating");
        ...
        razorpay.validateFields(payload, new Razorpay.ValidationListener() {
            ...
            public void onValidationSuccess() {
                try {
                    ...
                    razorpay.submit(payload, WalletRazorpayPayment.this);
                } catch (Exception e) {
    ...
    public void onPaymentError(int errorCode, String errorDescription, PaymentData paymentData) {
        ...
        if (paymentData != null) {
            ...
            Log.d(TAG, "API Response razorpay: onFailed" + jsondata+"\n"+paymentref);
        }
        ...
        if (errormessage.contains("number is invalid")) {
            ...
            SharedPrefUtil.setPaymentCheck(mContext, SHARED_PREF_PaymentCheck, "retain");
            WalletRazorpayPayment.this.finish();
            ...
            call.enqueue(new Callback<WalletPaymentResponse>() {
                ...
                public void onResponse(Call<WalletPaymentResponse> call, Response<WalletPaymentResponse> response) {
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        Log.e(TAG, "onResponse: successpayment"+dueamount );
                        /*try {
                            WalletFragment.tvBalance.setText("₹ " + amount);
                            Log.e(TAG, "onResponse: successpayment"+amount );
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try{
                        CheckBalance.tvBalance.setText("₹ "+amount);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        try {
                            WalletActivity.tvBalance.setText("₹ " + amount);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }*/
                        if (paystatus.equalsIgnoreCase("SUCCESS")) {
                            if (from.equalsIgnoreCase("wallet")) {
                                ...
                                mainIntent.putExtra("grandtotal",paidamount);
                        ...
                        if (paystatus.equalsIgnoreCase("FAILED")) {
                            ...
                            i.putExtra("grandtotal",dueamount);
                            i.putExtra("from",from);
                            Log.e(TAG, "onResponse: walletrazorpay"+from );
                            startActivity(i);
                            finish();
                        }
