...
import com.advira.advirafarm.buyer.ui.guest.adapter.ProductUnitAdapterGuest;
...
public class ProductDetailsActivityGuest extends AppCompatActivity implements IConsts {
    ...
    public static RelativeLayout btn_buynow, rl_addtocart;
    ...
    ProductUnitAdapterGuest productUnitAdapter;
    ...
    private EditText integer_number;
    ...
    private String isrx = "";
    private RelativeLayout rl_addremove;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ProductDetailsActivityGuest.this.finish();
        ...
        rl_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                i.setClass(ProductDetailsActivityGuest.this, CartActivity.class);
                startActivity(i);
        ...
        rl_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                i.setClass(ProductDetailsActivityGuest.this, Search_one.class);
                //i.setClass(ProductDetailsActivityGuest.this, SearchActivity.class);
                startActivity(i);
        ...
        carouselView.setImageClickListener(new ImageClickListener() {
            ...
            public void onClick(int position) {
               ...
               /* AlertDialog.Builder mBuilder = new AlertDialog.Builder(ProductDetailsActivity.this);
                ...
                Intent i = new Intent();
                i.setClass(ProductDetailsActivityGuest.this, ImageZoomSliderActivityGuest.class);
    ...
    private void initUI() {
        ...
        mContext = ProductDetailsActivityGuest.this;
        ...
        rl_addremove = findViewById(R.id.rl_addremove);
      ...
      /*  if (useractive.equalsIgnoreCase("active")) {
                ...
                if (Utilities.isNetworkConnected(mContext)) {
                    ...
                    if (Integer.parseInt(integer_number.getText().toString()) == moq) {
                        ...
                        if (minteger < 1) {
                            ...
                            CartDeleteRequest(productid.toString());
                        } else {
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AddToCart(tv_unitid.getText().toString(), "1");
            ...
            public void onClick(View view) {
                ...
                if (chkqty > 0) {
                    ...
                    if (Utilities.isNetworkConnected(mContext)) {
                        ...
                        AddToCart(tv_unitid.getText().toString(), spn_qty.getSelectedItem().toString());

                        if (useractive.equalsIgnoreCase("active")) {
                            AddToCart(tv_unitid.getText().toString(),  spn_qty.getSelectedItem().toString());


                            //AddToCart(productid, spn_qty.getSelectedItem().toString());
                        } else {
                          //  CheckProfile(productid, spn_qty.getSelectedItem().toString(), "addtocart");
                        }
                    ...
                    /*AlertDialog.Builder alert = new android.app.AlertDialog.Builder(ProductDetailsActivityGuest.this);
                    alert.setTitle("Alert!!");
                    alert.setMessage("Please select a valid quantity.");
                    alert.setPositiveButton("OK",null);
                    alert.show();*/
            ...
            public void onClick(View view) {
                ...
                if (chkqty > 0) {
                    ...
                    if (Utilities.isNetworkConnected(mContext)) {
                        ...
                        Intent i = new Intent();
                        i.setClass(ProductDetailsActivityGuest.this, OneTapLogin.class);
                        finishAffinity();
                        startActivity(i);
            ...
            public void onClick(View view) {
                ...
                if (integer_number.getText().toString().length() > 0) {
                    ...
                    if (Utilities.isNetworkConnected(mContext)) {
                        ...
                        Intent i = new Intent(ProductDetailsActivityGuest.this, OneTapLogin.class);
                        ProductDetailsActivityGuest.this.startActivity(i);
    ...
    private void ProductDetails() {
        ...
        Gson gson = new Gson();
        String vakk = gson.toJson(productDetailsRequest).toString();
        ...
        try {
            ...
            call.enqueue(new Callback<ProductDetailsResponse>() {
                ...
                public void onResponse(Call<ProductDetailsResponse> call, Response<ProductDetailsResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        //Log.e(TAG, "onResponse: productdetailguest"+response.body().getProductDetails() );

                        //Log.e(TAG, "onResponse: ProductdetailsGuest"+"\n"+vakk );



                        productUnitslist = new ArrayList<>();

                        productUnitAdapter = new ProductUnitAdapterGuest(mContext, productUnitslist);
                        ...
                        tv_desclaimerval.setText(response.body().getProductDetails().getProductOtherDetails());
     ...
     /*  private void BuyNow(String productid, String qty) {
           ...
           try {
               ...
               Call<BuyNowResponse> call = RetrofitUrlConnection.loadJSON(token).buynow(cartRequest);
               ...
               call.enqueue(new Callback<BuyNowResponse>() {
                   ...
                   public void onResponse(Call<BuyNowResponse> call, Response<BuyNowResponse> response) {
                       ...
                       if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                           ...
                           gst = response.body().getCartDate().getTax().replaceAll("%", "");
                           ...
                           Intent i = new Intent();
                           i.setClass(ProductDetailsActivityGuest.this, BuynowActivity.class);
                           i.putExtra("productname", tv_prodname.getText().toString());
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                      ...
                      /*  if (ShowAlert.contains("Personal details")) {
                            ...
                            Intent i = new Intent();
                            i.setClass(ProductDetailsActivityGuest.this, PersonalDetailsActivity.class);
                            i.putExtra("status", "inactive");
                            startActivity(i);
                        } else if (ShowAlert.contains("Business details")) {

                            Intent i = new Intent();
                            i.setClass(ProductDetailsActivityGuest.this, BusinessDetailsActivity.class);
                            i.putExtra("status", "inactive");
                            startActivity(i);
                        } else if (ShowAlert.contains("Upload KYC documents")) {

                            Intent i = new Intent();
                            i.setClass(ProductDetailsActivityGuest.this, DocumentUploadActivity.class);
                            i.putExtra("status", "inactive");
                            startActivity(i);
                        }*/
        ...
        alertDialog.setPositiveButton("OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (moreqty.length()!=0 || !moreqty.equals("")) {
            ...
            call.enqueue(new Callback<CartResponse>() {
                ...
                public void onResponse(Call<CartResponse> call, Response<CartResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        ProductDetailsActivityGuest.text.setText(response.body().getCartSize().toString());
                        Utilities.dismissDialog();
    ...
    private void CartDeleteRequest(String productunitid) {
        ...
        //cartDeleteRequest.setCartProductId(productunitid);
            ...
            call.enqueue(new Callback<CartDeleteResponse>() {
                ...
                public void onResponse(Call<CartDeleteResponse> call, Response<CartDeleteResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        MainActivityGuestNav.text.setText(response.body().getCartSize().toString());
                        text.setText(response.body().getCartSize().toString());
                        CartActivity.text.setText(response.body().getCartSize().toString());
                        Utilities.dismissDialog();
                        //Singleton.getInstance().showShortToast(mContext, response.body().getMessage());
