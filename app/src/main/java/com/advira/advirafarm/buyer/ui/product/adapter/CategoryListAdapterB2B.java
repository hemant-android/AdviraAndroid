...
public class CategoryListAdapterB2B extends RecyclerView.Adapter<CategoryListAdapterB2B.CategoryListViewHolder> implements IConsts {
    ...
    public CategoryListAdapterB2B(Context mContext, List<Product> productList) {
    ...
    public void onBindViewHolder(CategoryListViewHolder holder, int position) {
        ...
        if (useractive.equalsIgnoreCase("active")) {
            ...
            holder.tv_mrpval.setBackgroundResource(R.drawable.strike_through);
            //holder.tv_inr.setBackgroundResource(R.drawable.strike_through);
                ...
                public void onResponse(Call<CartResponse> call, Response<CartResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                       ...
                       // Singleton.getInstance().showShortToast(mContext, response.body().getMessage());
                        SharedPrefUtil.setCartCountB2B(mContext, IConsts.SHARED_PREF_CARTCOUNTB2B, response.body().getCartSize().toString());
    ...
    class CategoryListViewHolder extends RecyclerView.ViewHolder {
        ...
        public CategoryListViewHolder(View itemView) {
            ...
            if (useractive.equalsIgnoreCase("active")) {
                ...
                btn_add.setBackground(mContext.getResources().getDrawable(R.drawable.rounded_corner_gray_border));
