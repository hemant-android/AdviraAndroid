...
public class ProductUnit {
    ...
    @SerializedName("product_isDefault")
    @Expose
    private String productIsDefault;
    @SerializedName("product_banners")
    @Expose
    private List<ProductBanner> productBanners = null;
    ...
    public String getProductIsDefault() {
        return productIsDefault;
    }

    public void setProductIsDefault(String productIsDefault) {
        this.productIsDefault = productIsDefault;
    }
    ...
    public void setProductBanners(List<ProductBanner> productBanners) {
