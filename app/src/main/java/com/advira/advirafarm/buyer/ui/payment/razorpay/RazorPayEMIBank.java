...
public class RazorPayEMIBank extends Activity implements PaymentResultWithDataListener {

    private static final String TAG = RazorPayEMIBank.class.getSimpleName();
    String name = "";
    String cardNumber = "";
    String cvv = "";
    String month = "";
    ...
    private void netbankinglist() {
        LayoutInflater.from(RazorPayEMIBank.this).inflate(R.layout.fragment_method_netbanking_wallet_list, frameLayout, true);
    ...
    private void SubmitEMIDetails(String bankcode) {
        ...
        Intent mainIntent = new Intent(mContext, RazorPayEMIList.class);
        ...
        RazorPayEMIBank.this.startActivity(mainIntent);
        ...
        razorpay.validateFields(payload, new Razorpay.ValidationListener() {
            ...
            public void onValidationSuccess() {
                try {
                    ...
                    razorpay.submit(payload, RazorPayEMIBank.this);
                } catch (Exception e) {
            ...
            public void onValidationError(Map<String, String> error) {
                ...
                //Toast.makeText(RazorPayEMIBank.this, "Validation: " + error.get("field") + " " + error.get("description"), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onPaymentSuccess(String razorpayPaymentId, PaymentData paymentData) {
        ...
        webview.setVisibility(View.GONE);
        //Singleton.getInstance().showShortToast(RazorPayEMIBank.this, "Payment Successful");//remove toast
    ...
    public void onPaymentError(int errorCode, String errorDescription, PaymentData paymentData) {
        ...
        try {
            ...
            //Singleton.getInstance().showShortToast(mContext, errormessage+"---1");
        ...
        if (errormessage.contains("number is invalid")) {
            ...
            SharedPrefUtil.setPaymentCheck(mContext, SHARED_PREF_PaymentCheck, "retain");
            RazorPayEMIBank.this.finish();
            //Singleton.getInstance().showErrorLongToast(mContext, errormessage+"---2");
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        if (paystatus.equalsIgnoreCase("FAILED")) {
                           ...
                           // Singleton.getInstance().showShortToast(mContext, "Payment Error");
                            ...
                            {
                                //Singleton.getInstance().showErrorLongToast(mContext, errormessage+"---3");
                            }
                            else
                            {
