...
public class AddressfromMap extends AppCompatActivity implements OnMapReadyCallback {
    //location
    ...
    RelativeLayout rl_area,rl_back;
    ...
    //receiving
    private String mApiKey = "AIzaSyB3u2VFxJbQTa5u6aLDak8j0NwxzvZHiFg" ;
    //private String mApiKey = getResources().getString(R.string.gcm_api_key) ;
    private String[] mSupportedArea = new String[]{};
    private String mCountry = "";
    private String mLanguage = "en";

    private static final String TAG = AddressfromMap.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addressfrom_map);
        ...
        submitLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(from.equalsIgnoreCase("Home")) {
                    ...
                    i.putExtra("from", "currentadd");
                    i.putExtra("street", houseno);
                    i.putExtra("city",street);
                    i.putExtra("pincode", zip);
                    mContext.startActivity(i);
                }
    ...
    private void receiveIntent(){
        ...
        if (intent.hasExtra(mApiKey)){
            mApiKey = intent.getStringExtra(mApiKey);
        }

        if (intent.hasExtra(Constants.COUNTRY)){
            mCountry = intent.getStringExtra(Constants.COUNTRY);
        }

        if (intent.hasExtra(Constants.LANGUAGE)){
            mLanguage = intent.getStringExtra(Constants.LANGUAGE);
        }

        if (intent.hasExtra(Constants.SUPPORTED_AREAS)){
            mSupportedArea = intent.getStringArrayExtra(Constants.SUPPORTED_AREAS);
        }
    }
    ...
    private void submitResultLocation(){
        ...
        if (addressResultCode == FAILURE_RESULT || !isSupportedArea) {
            Toast.makeText(AddressfromMap.this, R.string.failed_select_location, Toast.LENGTH_SHORT).show();
        } else {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mapView != null && mapView.findViewById(Integer.parseInt("1")) != null) {
            ...
            layoutParams.setMargins(0, 175, 60, 0);
        }
        ...
        task.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    ...
                    try {
                        resolvable.startResolutionForResult(AddressfromMap.this, 51);
...
//                ToDo : you can use retrofit for this network call instead of using services
                ...
                .addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AddressfromMap.this, "Unable to get last location ", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void updateUi() {
        ...
        if (addressResultCode == SUCCESS_RESULT) {
            ...
            Log.e(TAG, "updateUi: Addressoutput"+"3"+addressOutput+"\n1"+houseno+"\n2"+street+"\n3"+city+"\n4"+state+"\n5"+mCountry+"\n6"+zip);
        }
    }
    ...
    class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            Log.e(TAG, "updateUi: AddressResult"+"3"+addressOutput+"\n1"+houseno+"\n2"+street+"\n3"+city+"\n4"+state+"\n5"+mCountry+"\n6"+pincode);
                ...
                public void onResponse(Call<CheckPinResponse> call, Response<CheckPinResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        if (response.body().getPincodeDetails().size() > 0) {
                            ...
                            submitLocationButton.setBackground(getResources().getDrawable(R.drawable.button_selector));
                           ...
                           /* AlertDialog.Builder builder = new AlertDialog.Builder(AutoDetectAddressList.this);
                            ...
                            submitLocationButton.setBackground(getResources().getDrawable(R.drawable.button_selector_gray));
                            submitLocationButton.setTextColor(getResources().getColor(R.color.white));
