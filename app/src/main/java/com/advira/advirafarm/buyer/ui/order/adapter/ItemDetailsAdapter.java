...
public class ItemDetailsAdapter extends RecyclerView.Adapter<ItemDetailsAdapter.CartViewHolder>{
    ...
    public ItemDetailsAdapter(Context mContext, List<OrderProductList> productDetailsList) {
        this.mContext = mContext;
        this.productDetailsList = productDetailsList;
    }

    @Override
    public ItemDetailsAdapter.CartViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.layout_itemdetails, null);
        return new ItemDetailsAdapter.CartViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ItemDetailsAdapter.CartViewHolder holder, int position) {
        ...
        holder.tv_orderqty.setText(product.getProductQuantity());
        ...
        holder.tv_price1.setText(form.format(price));
        holder.tv_price2.setText(form.format(totprice));
