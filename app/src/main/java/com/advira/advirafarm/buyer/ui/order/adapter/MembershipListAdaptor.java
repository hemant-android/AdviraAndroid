...
public class MembershipListAdaptor extends RecyclerView.Adapter<MembershipListAdaptor.OrderViewHolder> {
    ...
    private List<MemberDatum> orderList1;

    public MembershipListAdaptor(Context mContext, List<MemberDatum> orderList1) {
    ...
    public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layout_memorders, null);
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder holder, int position) {
        ...
        MemberDatum order = orderList1.get(position);


        //binding the data with the view holder views
        holder.tv_orderno.setText("  "+order.getMembershipDetails());
        holder.tv_deliv.setText(formatDate(order.getCreatedAt()));
        holder.tv_total_items.setText("Items : 1 ");
        holder.tv_total_orderval.setText("Amount : ₹ " + order.getPrice());
        if(order.getPaymentStatus().equalsIgnoreCase("Completed")) {
            holder.tv_status.setText("Expiry Date : " + order.getMembershipExpDate());
            holder.tv_paymentstatus.setText("Status : Success");
        }else{
            holder.tv_status.setVisibility(View.GONE);
            holder.tv_paymentstatus.setText("Status : "+order.getPaymentStatus());
        }
...
*/
        ...
        String pcl = "#00973D";
        String blk = "#000000";
        //int paymentsize = order.getPaymentStatus();
        ...
        /*try {
            if (order.getPayment().get(paymentsize).getPaymentStatus().equalsIgnoreCase("SUCCESS")) {
                ...
                if (order.getPayment().get(paymentsize).getPaymentMode().equalsIgnoreCase("COD") || order.getPayment().get(paymentsize).getPaymentMode().equalsIgnoreCase("Credit")) {
                    ...
                    String ordercreatedat=order.getCreatedAt();
