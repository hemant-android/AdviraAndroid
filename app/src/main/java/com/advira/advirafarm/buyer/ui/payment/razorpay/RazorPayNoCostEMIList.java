...
import com.advira.advirafarm.buyer.ui.payment.razorpay.adapter.NoCostEMIListAdapter;
...
public class RazorPayNoCostEMIList extends Activity implements PaymentResultWithDataListener {

    private static final String TAG = RazorPayNoCostEMIList.class.getSimpleName();
    ...
    NoCostEMIListAdapter noCostEMIListAdapter;
    String ordertype = "";
    String totalamount = "";
    String totaltax = "";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = RazorPayNoCostEMIList.this;
        try {
                ...
                builder.setMessage("Going back will abort the payment process. Are you sure ?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                RazorPayNoCostEMIList.this.finish();
      ...
      //  String paidamount = grandtotal.substring(0, grandtotal.length() - 3);
        ...
        ClickableSpan myClickableSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                ...
                Intent i = new Intent();
                i.setClass(RazorPayNoCostEMIList.this, WebViewActivity.class);
            ...
            call.enqueue(new Callback<BankNoCostEMIResponse>() {
                ...
                public void onResponse(Call<BankNoCostEMIResponse> call, Response<BankNoCostEMIResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        noCostEMIListAdapter = new NoCostEMIListAdapter(mContext, emiDatumList);
        ...
        razorpay.validateFields(payload, new Razorpay.ValidationListener() {
            ...
            public void onValidationSuccess() {
                try {
                    ...
                    razorpay.submit(payload, RazorPayNoCostEMIList.this);
                } catch (Exception e) {
            ...
            public void onValidationError(Map<String, String> error) {
                ...
                Toast.makeText(RazorPayNoCostEMIList.this, "Validation: " + error.get("field") + " " + error.get("description"), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onPaymentSuccess(String razorpayPaymentId, PaymentData paymentData) {
        ...
        webview.setVisibility(View.GONE);
        //Singleton.getInstance().showShortToast(RazorPayNoCostEMIList.this, "Payment Successful");
    ...
    public void onPaymentError(int errorCode, String errorDescription, PaymentData paymentData) {
        ...
        try {
            ...
            //singleton.getInstance().showShortToast(mContext, errormessage+"--22");
        ...
        if (errormessage.contains("number is invalid")) {
            ...
            SharedPrefUtil.setPaymentCheck(mContext, SHARED_PREF_PaymentCheck, "retain");
            RazorPayNoCostEMIList.this.finish();
            //singleton.getInstance().showErrorLongToast(mContext, errormessage+"--23");
                ...
                public void onResponse(Call<PGPaymentResponse> call, Response<PGPaymentResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        if (paystatus.equalsIgnoreCase("SUCCESS")) {
                            ...
                            RazorPayNoCostEMIList.this.startActivity(mainIntent);
                            RazorPayNoCostEMIList.this.finish();
                        }
                        ...
                        if (paystatus.equalsIgnoreCase("FAILED")) {
                            ...
                            if (errormessage.length() > 1) {
                                //singleton.getInstance().showErrorLongToast(mContext, errormessage+"--24");
                            } else {
