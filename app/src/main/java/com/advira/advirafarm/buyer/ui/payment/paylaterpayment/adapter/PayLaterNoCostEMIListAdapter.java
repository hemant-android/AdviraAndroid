...
import com.advira.advirafarm.buyer.ui.payment.paylaterpayment.PayLaterRazorPayNoCostEMIList;
import com.advira.advirafarm.buyer.ui.payment.razorpay.api.EmiDatumNoCost;

import java.util.List;


public class PayLaterNoCostEMIListAdapter extends RecyclerView.Adapter<PayLaterNoCostEMIListAdapter.EMIViewHolder> implements IConsts {
    ...
    public PayLaterNoCostEMIListAdapter(Context mContext, List<EmiDatumNoCost> emiListData) {
    ...
    public void onBindViewHolder(EMIViewHolder holder, int position) {
        ...
        PayLaterRazorPayNoCostEMIList.tv_emidiscount.setText("No Cost EMI Discount ₹"+ emiDatum.getDiscount().toString() );
                ...
                for (int i = 0; i < emiListData.size(); i++) {
                    if (i == position) {
                        try
                        {
                            ...
                            PayLaterRazorPayNoCostEMIList.tv_tenure.setText(emiListData.get(i).getEmiDuration().toString());
                            PayLaterRazorPayNoCostEMIList.tv_emidiscount.setText("No Cost EMI Discount ₹"+ emiListData.get(i).getDiscount().toString() );
