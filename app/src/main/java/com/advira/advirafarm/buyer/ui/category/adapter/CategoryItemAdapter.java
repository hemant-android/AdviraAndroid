...
public class CategoryItemAdapter extends RecyclerView.Adapter<CategoryItemAdapter.CategoryListViewHolder> implements IConsts {
    ...
    public CategoryItemAdapter(Context mContext, List<Product> productList) {
    ...
    public CategoryListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layout_categortitemproducts, null);
    ...
    public void onBindViewHolder(CategoryListViewHolder holder, int position) {
       ...
       // String productInstock = "In-Stock";
        ...
        holder.tv_inr.setText("Rate Per "+product.getProductUnits().get(0).getProductUnitType()+" : ₹ ");
            ...
            public void onClick(View view) {
                ...
                String useractive = SharedPrefUtil.getUserActive(mContext, SHARED_PREF_UserActive, "inactive");
                    ...
                    if (useractive.equalsIgnoreCase("active")) {
                        ...
                        CheckProfile(holder.tv_productid.getText().toString(), String.valueOf("1"));
            ...
            cv_product.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (profilemode.equalsIgnoreCase("B2C")) {
                        ...
                        //toast.maketext(view.getContext(), "Search Data Saved-4", Toast.LENGTH_LONG).show();
                        ...
                        i.putExtra("productname", tv_productname.getText().toString());
                        i.putExtra("productid", tv_productid.getText().toString());
                        //toast.maketext(view.getContext(), "Search Data Saved-142", Toast.LENGTH_LONG).show();
                        mContext.startActivity(i);
                    }
