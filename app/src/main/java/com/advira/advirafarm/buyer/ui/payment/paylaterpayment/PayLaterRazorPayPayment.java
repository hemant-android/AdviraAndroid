...
public class PayLaterRazorPayPayment extends Activity implements PaymentResultWithDataListener {

    private static final String TAG = PayLaterRazorPayPayment.class.getSimpleName();
    String name = "";
    String cardNumber = "";
    String cvv = "";
    String month = "";
 ...
 @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = PayLaterRazorPayPayment.this;
        try {
                ...
                builder.setMessage("Going back will abort the payment process. Are you sure ?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                PayLaterRazorPayPayment.this.finish();
    ...
    private void netbankinglist() {
        LayoutInflater.from(PayLaterRazorPayPayment.this).inflate(R.layout.fragment_method_netbanking_wallet_list, frameLayout, true);
        ...
        razorpay.isValidVpa(name, new ValidateVpaCallback() {
            ...
            public void onResponse(boolean b) {
                if (b) {
                    ...
                    Singleton.getInstance().showErrorLongToast(PayLaterRazorPayPayment.this, "VPA is Not valid");
            ...
            public void onFailure() {
                Singleton.getInstance().showErrorLongToast(PayLaterRazorPayPayment.this, "Error in validating");
        ...
        razorpay.validateFields(payload, new Razorpay.ValidationListener() {
            ...
            public void onValidationSuccess() {
                try {
                    ...
                    razorpay.submit(payload, PayLaterRazorPayPayment.this);
                } catch (Exception e) {
                ...
                public void onResponse(Call<PGPaymentResponse> call, Response<PGPaymentResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        if (paystatus.equalsIgnoreCase("SUCCESS")) {
                            ...
                            PayLaterRazorPayPayment.this.startActivity(mainIntent);
                            PayLaterRazorPayPayment.this.finish();
                        }
