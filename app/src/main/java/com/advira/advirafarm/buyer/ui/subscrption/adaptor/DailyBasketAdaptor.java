...
public class DailyBasketAdaptor extends RecyclerView.Adapter<DailyBasketAdaptor.DairyBasketViewHolder> implements IConsts {
    ...
    public DailyBasketAdaptor(Context mContext, List<Product_Basket> productList) {
