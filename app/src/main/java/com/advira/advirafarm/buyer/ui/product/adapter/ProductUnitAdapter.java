...
public class ProductUnitAdapter extends RecyclerView.Adapter<ProductUnitAdapter.ProductUnitListViewHolder> implements IConsts {
    ...
    public ProductUnitAdapter(Context mContext, List<ProductUnit> productUnit) {
    ...
    public void onBindViewHolder(ProductUnitListViewHolder holder, int position) {
        ...
        holder.cv_product.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProductDetailsActivity.tv_price.setText(form.format(price));
                ProductDetailsActivity.tv_mrpval.setText(form.format(mrp));
                ProductDetailsActivity.tv_unitid.setText(holder.tv_unitid.getText().toString());
                ProductDetailsActivity.tv_packsize.setText(holder.tv_unit.getText().toString());
                    ...
                    if (i == position) {
                       // holder.cv_product.setBackground(mContext.getResources().getDrawable(R.drawable.border_bg_color_red));
                        ...
                        if (productUnit.get(i).getProductInstock().equalsIgnoreCase("Out-of-Stock")) {
                            ProductDetailsActivity.tv_stock.setText("Out-of-Stock");
                            ProductDetailsActivity.tv_stock.setVisibility(View.VISIBLE);
                            ProductDetailsActivity.ll_addremovebutton.setVisibility(View.INVISIBLE);
                            ProductDetailsActivity.ll_addremove.setVisibility(View.INVISIBLE);
                            ProductDetailsActivity.btn_buynow.setEnabled(false);
                            ProductDetailsActivity.rl_addtocart.setEnabled(false);
                            ProductDetailsActivity.tv_placeorder.setText("Out of Stock");
                        } else {
                            ProductDetailsActivity.tv_stock.setVisibility(View.INVISIBLE);
                            ProductDetailsActivity.ll_addremovebutton.setVisibility(View.INVISIBLE);
                            ProductDetailsActivity.btn_buynow.setEnabled(true);
                            ProductDetailsActivity.ll_addremove.setVisibility(View.INVISIBLE);
                            ProductDetailsActivity.rl_addtocart.setEnabled(true);
                            ProductDetailsActivity.tv_placeorder.setText("Buy Now");
                        }
                ...
                ProductDetailsActivity.CarousalImageChange(productImagesList);
                ProductDetailsActivity.spn_qty.setSelection(0);
