...
public class CategoryListHeaderAdapterPagging extends PagedListAdapter<ProductList_home,CategoryListHeaderAdapterPagging.CategoryListHeaderViewHolder> {
    ...
    public CategoryListHeaderAdapterPagging(Context mContext, List<ProductList_home> productList) {
        super(itemCallback);
    ...
    @NonNull
    @Override
    public CategoryListHeaderAdapterPagging.CategoryListHeaderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CategoryListHeaderAdapterPagging.CategoryListHeaderViewHolder holder, int position) {
    ...
    public class CategoryListHeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public CategoryListHeaderViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    private static DiffUtil.ItemCallback<ProductList_home> itemCallback=new DiffUtil.ItemCallback<ProductList_home>() {
        @Override
        public boolean areItemsTheSame(@NonNull ProductList_home oldItem, @NonNull ProductList_home newItem) {
            return oldItem.getDatabase_id() == newItem.getDatabase_id();
        }

        @SuppressLint("DiffUtilEquals")
        @Override
        public boolean areContentsTheSame(@NonNull ProductList_home oldItem, @NonNull ProductList_home newItem) {
