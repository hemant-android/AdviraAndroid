...
public class RFQMobileOTPActivity extends Activity {
    ...
    private void initUI() {
        ...
        mContext = RFQMobileOTPActivity.this;
        ...
        call.enqueue(new Callback<OTPVerifyResponse>() {
            ...
            public void onResponse(Call<OTPVerifyResponse> call, Response<OTPVerifyResponse> response) {
                ...
                if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                    ...
                    if (from.equalsIgnoreCase("rfq")) {
                        Intent i = new Intent();
                        i.setClass(RFQMobileOTPActivity.this, RFQDoneActivity.class);
                        startActivity(i);
                    }
