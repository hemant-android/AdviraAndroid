...
public class CategoryNameAdapter extends RecyclerView.Adapter<CategoryNameAdapter.CategoryListViewHolder> implements IConsts {
    ...
    public CategoryNameAdapter(Context mContext, List<ProductList> productList) {
    ...
    public CategoryListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layout_categorynameheader, null);
