...
public class BasketDetailsUpdateviaDateAdaptor extends RecyclerView.Adapter<BasketDetailsUpdateviaDateAdaptor.BasketDetailsUpdatViewHolder> implements IConsts {
    ...
    public BasketDetailsUpdateviaDateAdaptor(Context mContext, List<BasketDatum> productList) {
