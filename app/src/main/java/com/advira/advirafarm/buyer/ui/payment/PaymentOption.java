package com.advira.advirafarm.buyer.ui.payment;
...
public class PaymentOption extends AppCompatActivity implements IConsts {
            ...
            public void onClick(View v) {
                ...
                if (retryorderid.toString().length() > 0) {
                    ...
                    if (from.equalsIgnoreCase("back")) {
                        ...
                        Intent i = new Intent();
                        i.setClass(PaymentOption.this, MainActivityNav.class);
                        finishAffinity();
                        startActivity(i);
                    }
        ...
        btn_proceedtopay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (paymenttype.equalsIgnoreCase("")) {
                    AlertDialog.Builder alert = new AlertDialog.Builder(PaymentOption.this);
    ...
    private void initUI() {
        ...
        if (extras != null) {
            ...
            delivery_date=extras.getString("delivery_slot_date");
            delivery_time=extras.getString("delivery_time");
            ...
            public void onResponse(Call<RzpayOrderInitResponse> call, Response<RzpayOrderInitResponse> response) {
                ...
                if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                    ...
                    if (paymenttype.equalsIgnoreCase("Pay with Debit/Credit Card")) {
                        ...
                        Intent intent = new Intent(PaymentOption.this, RazorPayPayment.class);
                        ...
                        Intent intent = new Intent(PaymentOption.this, RazorPayEMIBank.class);
                        intent.putExtra("paymentcode", paymentcode);
                        intent.putExtra("name", name);
                        intent.putExtra("cardno", cardno);
                        intent.putExtra("cvv", cvv);
                        ...
                        Intent intent = new Intent(PaymentOption.this, RazorPayNoCostEMIBank.class);
                        intent.putExtra("paymentcode", paymentcode);
                        intent.putExtra("name", name);
                        intent.putExtra("cardno", cardno);
                        intent.putExtra("cvv", cvv);
                        ...
                        intent.putExtra("adviraorderid", orderId);
                        intent.putExtra("adviraorderno", orderNo);
                        Log.e(TAG, "onResponse: paymentoptionactivity"+orderId+"---"+orderNo+"--"+rzrpayorderid );
                        startActivity(intent);
                        ...
                        Intent intent = new Intent(PaymentOption.this, RazorPayPaymentUPI.class);
                        intent.putExtra("paymentcode", paymentcode);
                        intent.putExtra("name", "");
                        intent.putExtra("cardno", "");
                        intent.putExtra("cvv", "");
    ...
    public void GenerateOrderId(String paymentoption) {
        ...
        orderPlacedRequest.setDeliverySlotDate(delivery_date);
        orderPlacedRequest.setDeliverySlotTime(delivery_time);
        Gson gson = new Gson();
        String jsondata = gson.toJson(orderPlacedRequest);
        // String orderstatus = response.body().getOrderDetails().get(0).getDeliveryStatus();
        Log.e(TAG, "onResponse: sapna_orderstatus"+jsondata+"\n"+jsondata );
        try {
                ...
                public void onResponse(Call<OrderPlacedResponse> call, Response<OrderPlacedResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        /*if (paymenttype.equalsIgnoreCase("wallet") || paymenttype.equalsIgnoreCase("Pay with Credit Card")) {
                            ...
                            rzpayOrderInitRequest(retryorderid, paymentoption);
