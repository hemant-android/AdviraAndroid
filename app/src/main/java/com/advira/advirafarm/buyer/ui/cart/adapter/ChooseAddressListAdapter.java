...
public class ChooseAddressListAdapter extends RecyclerView.Adapter<ChooseAddressListAdapter.AddressViewHolder> implements IConsts {
    ...
    public ChooseAddressListAdapter(Context mContext, List<AddressDate> addressListData) {
    ...
    public void onBindViewHolder(AddressViewHolder holder, int position) {
        ...
        //holder.tv_addname.setText(SharedPrefUtil.getUserName(mContext, SHARED_PREF_UserName, ""));
        //holder.tv_addtype.setText(addressListData1.getAddressType());
        ...
        if (addressListData1.getIsDafault().equalsIgnoreCase("0")) {
            ...
            //String headeraddress = "Deliver to " + addressListData1.getCityName() + " " + addressListData1.getPincode();
            ...
            SharedPrefUtil.setDefaultAddressId(mContext, SHARED_PREF_DefaultAddressID, addressListData1.getId());
                ...
                builder.setMessage("Are you sure you want to delete this address?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                DeleteAddress(holder.tv_addid.getText().toString(), addressListData1);
    ...
    private void DeleteAddress(String addid, AddressDate addressListData1) {
