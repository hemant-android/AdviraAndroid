...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions1(Context context, PickerOptionListener listener) {
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        // setup the alert builder
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle(context.getString(R.string.lbl_insect_photo));
    ...
    public static void showImagePickerOptionsSample(Context context, PickerOptionListener listener) {
        // setup the alert builder
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle(context.getString(R.string.tv_samplepic));
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.colorThemeDark));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.colorStatusbar));
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.colorThemeDark));
    ...
    private void setResultOk(Uri imagePath) {
        ...
        Log.v("imagename", imagePath.toString());
