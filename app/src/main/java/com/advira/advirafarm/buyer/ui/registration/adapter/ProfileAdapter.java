...
public class ProfileAdapter extends ArrayAdapter<ProfileTypeList> {

    LayoutInflater flater;

    public ProfileAdapter(AppCompatActivity context, int resouceId, int textviewId, List<ProfileTypeList> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ProfileTypeList item = getItem(position);
