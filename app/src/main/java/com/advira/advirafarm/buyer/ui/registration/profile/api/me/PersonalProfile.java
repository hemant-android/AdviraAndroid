...
public class PersonalProfile {
    ...
    @SerializedName("permanent_address_state_name")
    @Expose
    private String permanentAddressStateName;
    @SerializedName("permanent_address_city")
    @Expose
    private String permanentAddressCity;
    @SerializedName("permanent_address_city_name")
    @Expose
    private String permanentAddressCityName;
    ...
    public String getCurrentAddressStateName() {
        return currentAddressStateName;
    }

    public void setCurrentAddressStateName(String currentAddressStateName) {
        this.currentAddressStateName = currentAddressStateName;
    }
    ...
    public String getCurrentAddressCityName() {
        return currentAddressCityName;
    }

    public void setCurrentAddressCityName(String currentAddressCityName) {
        this.currentAddressCityName = currentAddressCityName;
    }
    ...
    public String getPermanentAddressStateName() {
        return permanentAddressStateName;
    }

    public void setPermanentAddressStateName(String permanentAddressStateName) {
        this.permanentAddressStateName = permanentAddressStateName;
    }
    ...
    public String getPermanentAddressCityName() {
        return permanentAddressCityName;
    }

    public void setPermanentAddressCityName(String permanentAddressCityName) {
        this.permanentAddressCityName = permanentAddressCityName;
    }
