...
public class ChooseAddressList extends AppCompatActivity implements IConsts {

    private RelativeLayout rl_back ,rl_search,rl_cart,rl_footer,rl_currentaddress;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rl_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                i.setClass(ChooseAddressList.this, CartActivity.class);
                startActivity(i);
        ...
        rl_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                //i.setClass(ChooseAddressList.this, SearchActivity.class);
                i.setClass(ChooseAddressList.this, Search_one.class);
                startActivity(i);
                ...
                builder.setMessage("Do you wish to continue?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                i.putExtra("from","chooseaddresslist");
    ...
    private void initUI() {
        ...
        mContext = ChooseAddressList.this;
