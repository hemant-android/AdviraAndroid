...
public class MyAccountfragment extends BaseContainerFragment implements IConsts {
    ...
    public static TextView tv_dobval;
    public static TextView tv_genderval;
    ...
    public static MyAccountfragment newInstance(String string) {
        MyAccountfragment fragment = new MyAccountfragment();
        /*Bundle args = new Bundle();
        args.putString("MY_FRAGMENT", string);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            ...
            btn_upgradeplan.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    private void initUI() {
        ...
        rl_membership=rootView.findViewById(R.id.rl_membership);
        btn_upgradeplan=rootView.findViewById(R.id.btn_upgradeplan);
        ...
        name = SharedPrefUtil.getUserName(mContext, SHARED_PREF_UserName, "");
            ...
            public void onResponse(Call<MeResponse> call, Response<MeResponse> response) {
                ...
                if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                    ...
                    if (response.body().getBasicInfo().size() > 0) {
                        ...
                        name=response.body().getBasicInfo().get(0).getName();
                        mobile=response.body().getBasicInfo().get(0).getMobileNo();
                        et_email.setText(response.body().getBasicInfo().get(0).getEmail());
                        if(response.body().getBasicInfo().get(0).getEmail().equalsIgnoreCase("")){
                        ...
                        if (emailverify.equalsIgnoreCase("1")) {
                            ...
                            rl_emailview.setVisibility(View.VISIBLE);
                        }
                        ...
                        if (image_url.length() > 5) {
                            Picasso.with(mContext).load(image_url).placeholder(R.drawable.progress_animation).resize(500,0).error(R.drawable.image_not_available).into(profile_image);
            ...
            public void onResponse(@NotNull Call<ProfilePictureResponse> call, @NotNull Response<ProfilePictureResponse> response) {
                ...
                if (response.body() != null) {
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        try{
                            if (profilepic.length() > 5) {
                                Picasso.with(mContext).load(profilepic).placeholder(R.drawable.progress_animation).resize(500,0).error(R.drawable.image_not_available).into(MainActivityNav.profile_image);
                            }
                            /*else{
                ...
                //Utilities.dismissDialog();
                    ...
                    Picasso.with(mContext).load(R.drawable.image_not_available).into(profile_image);
                }
                Utilities.dismissDialog();
            ...
            call.enqueue(new Callback<IsUserVerifiedResponse>() {
                ...
                public void onResponse(Call<IsUserVerifiedResponse> call, Response<IsUserVerifiedResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        //Log.e(TAG, "onResponse: personaledit "+ "    "+personalEdit );


                        if (response.body().getPersonalProfileStatus().equalsIgnoreCase("1")) {
                            rl_personaledit.setVisibility(View.VISIBLE);
                        } else {
                            rl_personaledit.setVisibility(View.VISIBLE);
                        }
