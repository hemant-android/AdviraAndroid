...
import com.advira.advirafarm.buyer.ui.payment.paylaterpayment.adapter.PayLaterEMIListAdapter;
...
public class PayLaterRazorPayEMIList extends Activity implements PaymentResultWithDataListener {

    private static final String TAG = PayLaterRazorPayEMIList.class.getSimpleName();
    ...
    PayLaterEMIListAdapter emiListAdapter;
    ...
    private TextView tv_terms,tv_newadd_header2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = PayLaterRazorPayEMIList.this;
        try {
                ...
                builder.setMessage("Going back will abort the payment process. Are you sure ?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                PayLaterRazorPayEMIList.this.finish();
    ...
    private void initRazorpay() {
        ...
        ClickableSpan myClickableSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                ...
                Intent i = new Intent();
                i.setClass(PayLaterRazorPayEMIList.this, WebViewActivity.class);
            ...
            call.enqueue(new Callback<BankEMIResponse>() {
                ...
                public void onResponse(Call<BankEMIResponse> call, Response<BankEMIResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        emiListAdapter = new PayLaterEMIListAdapter(mContext, emiDatumList);
    ...
    private void sendRequest() {
        razorpay.validateFields(payload, new Razorpay.ValidationListener() {
            ...
            public void onValidationSuccess() {
                try {
                    webview.setVisibility(View.VISIBLE);
                    razorpay.submit(payload, PayLaterRazorPayEMIList.this);
                } catch (Exception e) {
            ...
            public void onValidationError(Map<String, String> error) {
                ...
                Toast.makeText(PayLaterRazorPayEMIList.this, "Validation: " + error.get("field") + " " + error.get("description"), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onPaymentSuccess(String razorpayPaymentId, PaymentData paymentData) {
        ...
        webview.setVisibility(View.GONE);
        //Singleton.getInstance().showShortToast(PayLaterRazorPayEMIList.this, "Payment Successful");//remove toast
    ...
    public void onPaymentError(int errorCode, String errorDescription, PaymentData paymentData) {
        ...
        try {
            ...
            //Singleton.getInstance().showShortToast(mContext, errormessage+"---7");
        ...
        if (errormessage.contains("number is invalid")) {
            ...
            SharedPrefUtil.setPaymentCheck(mContext, SHARED_PREF_PaymentCheck, "retain");
            PayLaterRazorPayEMIList.this.finish();
            //Singleton.getInstance().showErrorLongToast(mContext, errormessage+"---8");
            ...
            call.enqueue(new Callback<PGPaymentResponse>() {
                ...
                public void onResponse(Call<PGPaymentResponse> call, Response<PGPaymentResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        Intent mainIntent = new Intent(PayLaterRazorPayEMIList.this, OrderDetailsActivity.class);
                        mainIntent.putExtra("orderid",adviraorderid);
                        mainIntent.putExtra("from","finish");
                        finish();
                        PayLaterRazorPayEMIList.this.startActivity(mainIntent);
