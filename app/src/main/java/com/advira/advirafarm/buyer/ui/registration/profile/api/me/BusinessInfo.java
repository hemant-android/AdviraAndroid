...
public class BusinessInfo {
    ...
    @SerializedName("drug_license_expiration")
    @Expose
    private String drugLicenseExpiration;
    ...
    public String getDrugLicenseExpiration() {
        return drugLicenseExpiration;
    }

    public void setDrugLicenseExpiration(String drugLicenseExpiration) {
        this.drugLicenseExpiration = drugLicenseExpiration;
    }
