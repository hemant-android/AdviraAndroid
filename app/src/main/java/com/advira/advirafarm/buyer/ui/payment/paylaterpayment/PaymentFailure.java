...
public class PaymentFailure extends AppCompatActivity implements IConsts{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_retrypayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mainIntent = new Intent(PaymentFailure.this, PayLaterPaymentOption.class);
                ...
                finishAffinity();
                PaymentFailure.this.startActivity(mainIntent);
        ...
        tv_goto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mainIntent = new Intent(PaymentFailure.this, OrderDetailsActivity.class);
                mainIntent.putExtra("orderid",orderid);
                mainIntent.putExtra("from","finish");
                finish();
                PaymentFailure.this.startActivity(mainIntent);
        ...
        tv_cancelorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                i.setClass(PaymentFailure.this, OrderFailedCancellationActivity.class);
        ...
        rl_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                i.setClass(PaymentFailure.this, CartActivity.class);
                finishAffinity();
                startActivity(i);
        ...
        rl_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                //i.setClass(PaymentFailure.this, SearchActivity.class);
                i.setClass(PaymentFailure.this, Search_one.class);
                finishAffinity();
                startActivity(i);
    ...
    private void initUI() {
        ...
        tv_msg.setText("Your Order has been received");
