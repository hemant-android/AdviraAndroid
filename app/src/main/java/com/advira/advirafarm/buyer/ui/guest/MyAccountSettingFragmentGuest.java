...
import com.advira.advirafarm.buyer.ui.myaccount.ChangeMyPaswordActivity;
...
public class MyAccountSettingFragmentGuest extends BaseContainerFragment implements IConsts {

    public static MyAccountSettingFragmentGuest newInstance() {
        MyAccountSettingFragmentGuest fragment = new MyAccountSettingFragmentGuest();
        return fragment;
    }
    ...
    private void initUI() {
        ...
        rl_changepass.setVisibility(View.INVISIBLE);
