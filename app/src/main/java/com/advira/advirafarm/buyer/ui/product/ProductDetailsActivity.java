...
public class ProductDetailsActivity extends AppCompatActivity implements IConsts {
    ...
    public static TextView tv_stock,tv_placeorder,tv_isDeal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                i.setClass(ProductDetailsActivity.this, CartActivity.class);
                startActivity(i);
        ...
        rl_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                //i.setClass(ProductDetailsActivity.this, SearchActivity.class);
                i.setClass(ProductDetailsActivity.this, Search_one.class);
                startActivity(i);
        ...
        carouselView.setImageClickListener(new ImageClickListener() {
            ...
            public void onClick(int position) {
               ...
               /* AlertDialog.Builder mBuilder = new AlertDialog.Builder(ProductDetailsActivity.this);
                ...
                Intent i = new Intent();
                i.setClass(ProductDetailsActivity.this, ImageZoomSliderActivityB2B.class);
    ...
    private void initUI() {
        ...
        tv_addto = findViewById(R.id.tv_addto);
        rl_addtocart = findViewById(R.id.rl_addtocart);
        tv_isDeal=findViewById(R.id.tv_isDeal);
...
*/
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (useractive.equalsIgnoreCase("guest")) {
                    ...
                    Intent i = new Intent();
                    i.setClass(ProductDetailsActivity.this, LoginActivity.class);
                    finishAffinity();
                    startActivity(i);
        ...
        tv_isDeal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Singleton.getInstance().showLongToast(mContext, "We're sorry! Only 1 Unit(s) allowed in each User.");
            }
        });
        ...
        btn_addto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (chkqty > 0) {
                    ...
                    android.app.AlertDialog.Builder alert = new android.app.AlertDialog.Builder(ProductDetailsActivity.this);
        ...
        rl_addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (chkqty > 0 || isDeal.equalsIgnoreCase("yes")) {
                    Utilities.hideKeyboard(mContext);
                    if (Utilities.isNetworkConnected(mContext)) {
            ...
            call.enqueue(new Callback<BuyNowResponse>() {
                ...
                public void onResponse(Call<BuyNowResponse> call, Response<BuyNowResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        Intent i = new Intent();
                        i.setClass(ProductDetailsActivity.this, BuynowActivity.class);
                        i.putExtra("productname", tv_prodname.getText().toString());
            ...
            call.enqueue(new Callback<ProductDetailsResponse>() {
                ...
                public void onResponse(Call<ProductDetailsResponse> call, Response<ProductDetailsResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        productUnitAdapter = new ProductUnitAdapter(mContext, productUnitslist);
                        ...
                        instock = response.body().getProductDetails().getProductUnit().get(0).getProductInstock();
                        isDeal=response.body().getProductDetails().getIsDeal();
                        if(isDeal.equalsIgnoreCase("Yes")){
                            spn_qty.setVisibility(View.GONE);
                            tv_isDeal.setVisibility(View.VISIBLE);

                        }else{
                            tv_isDeal.setVisibility(View.GONE);
                        }
                        ...
                        if (instock.equalsIgnoreCase("Out-of-Stock")) {
                            ...
                            //rl_addtocart.getBackground().setColorFilter(Color.parseColor("#A5A5A5"), PorterDuff.Mode.SRC);
                            rl_addtocart.setBackground(mContext.getResources().getDrawable(R.drawable.button_selector_gray));
                            tv_addto.setTextColor(Color.parseColor("#000000"));
                            tv_placeorder.setTextColor(Color.parseColor("#000000"));
                            btn_buynow.setBackground(mContext.getResources().getDrawable(R.drawable.button_selector_gray));
                            //btn_buynow.getBackground().setColorFilter(Color.parseColor("#A5A5A5"), PorterDuff.Mode.SRC);
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (ShowAlert.contains("Personal details")) {
                            ...
                            Intent i = new Intent();
                            i.setClass(ProductDetailsActivity.this, PersonalDetailsEditActivity.class);
                            i.putExtra("status", "inactive");
                            startActivity(i);
                        } else if (ShowAlert.contains("Business details")) {

                            Intent i = new Intent();
                            i.setClass(ProductDetailsActivity.this, BusinessDetailsActivity.class);
                            i.putExtra("status", "inactive");
                            startActivity(i);
                        } else if (ShowAlert.contains("Upload KYC documents")) {

                            Intent i = new Intent();
                            i.setClass(ProductDetailsActivity.this, DocumentUploadActivity.class);
                            i.putExtra("status", "inactive");
                            startActivity(i);
                        }
    ...
    private void calculateprice(String moreqty) {
        ...
        try {
            ...
            if (moreqty.length() > 0) {
                ...
                int chkqty=Integer.valueOf(moreqty);
                /*if(isDeal.equalsIgnoreCase("Yes")){
                    chkqty = Integer.valueOf("1");
                }else{
                    chkqty = Integer.valueOf(moreqty);
                }*/
