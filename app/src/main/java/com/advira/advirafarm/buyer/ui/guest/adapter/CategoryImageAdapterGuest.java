...
public class CategoryImageAdapterGuest extends RecyclerView.Adapter<CategoryImageAdapterGuest.CategoryListViewHolder> implements IConsts {
    ...
    public CategoryImageAdapterGuest(Context mContext, List<CategoryList> productList) {
