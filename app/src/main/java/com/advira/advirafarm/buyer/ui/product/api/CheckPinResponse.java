...
public class CheckPinResponse {
    ...
    @Expose
    private List<PincodeDetails> pincodeDetails = null;
    ...
    public List<PincodeDetails> getPincodeDetails() {
        return pincodeDetails;
    }

    public void setPincodeDetails(List<PincodeDetails> pincodeDetails) {
