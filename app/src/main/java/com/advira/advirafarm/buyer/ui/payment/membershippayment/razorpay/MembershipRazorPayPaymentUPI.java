...
public class MembershipRazorPayPaymentUPI extends Activity implements PaymentResultWithDataListener {

    private static final String TAG = MembershipRazorPayPaymentUPI.class.getSimpleName();
    String name = "";
    String cardNumber = "";
    String cvv = "";
    String month = "";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = MembershipRazorPayPaymentUPI.this;
                ...
                builder.setMessage("Going back will abort the payment process. Are you sure ?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                MembershipRazorPayPaymentUPI.this.finish();
        ...
        razorpay.isValidVpa(vpaname, new ValidateVpaCallback() {
            ...
            public void onResponse(boolean b) {
                if (b) {
                    ...
                    Toast.makeText(MembershipRazorPayPaymentUPI.this, "UPI ID is Not valid", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onFailure() {
                Toast.makeText(MembershipRazorPayPaymentUPI.this, "Invalid VPA/UPI ID", Toast.LENGTH_LONG).show();
                finish();
            }
        });
        ...
        razorpay.validateFields(payload, new Razorpay.ValidationListener() {
            ...
            public void onValidationSuccess() {
                try {
                    ...
                    razorpay.submit(payload, MembershipRazorPayPaymentUPI.this);
                } catch (Exception e) {
            ...
            public void onValidationError(Map<String, String> error) {
                ...
                Toast.makeText(MembershipRazorPayPaymentUPI.this, "Validation: " + error.get("field") + " " + error.get("description"), Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                public void onResponse(Call<PGPaymentResponse> call, Response<PGPaymentResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        if (paystatus.equalsIgnoreCase("SUCCESS")) {
                            ...
                            mainIntent.putExtra("orderno", adviraorderno);
                            mainIntent.putExtra("orderid", adviraorderid);
                            MembershipRazorPayPaymentUPI.this.startActivity(mainIntent);
                            MembershipRazorPayPaymentUPI.this.finish();
                        }
