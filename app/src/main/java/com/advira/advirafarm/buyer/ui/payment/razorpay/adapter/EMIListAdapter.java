...
public class EMIListAdapter extends RecyclerView.Adapter<EMIListAdapter.EMIViewHolder> implements IConsts {
    ...
    public EMIListAdapter(Context mContext, List<EmiDatum> emiListData) {
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < emiListData.size(); i++) {
                    if (i == position) {
                        ...
                        RazorPayEMIList.tv_tenure.setText(emiListData.get(i).getEmiDuration().toString());
