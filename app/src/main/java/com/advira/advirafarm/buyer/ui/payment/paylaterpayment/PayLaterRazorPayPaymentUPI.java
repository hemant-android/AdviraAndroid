...
public class PayLaterRazorPayPaymentUPI extends Activity implements PaymentResultWithDataListener {

    private static final String TAG = PayLaterRazorPayPaymentUPI.class.getSimpleName();
    String name = "";
    String cardNumber = "";
    String cvv = "";
    String month = "";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = PayLaterRazorPayPaymentUPI.this;
                ...
                builder.setMessage("Going back will abort the payment process. Are you sure ?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                PayLaterRazorPayPaymentUPI.this.finish();
        ...
        razorpay.isValidVpa(vpaname, new ValidateVpaCallback() {
            ...
            public void onResponse(boolean b) {
                if (b) {
                    ...
                    Toast.makeText(PayLaterRazorPayPaymentUPI.this, "UPI ID is Not valid", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onFailure() {
                Toast.makeText(PayLaterRazorPayPaymentUPI.this, "Invalid VPA/UPI ID", Toast.LENGTH_LONG).show();
                finish();
            }
        });
    ...
    public void SubmitUPIIntentDetails() {
        ...
        try {
            ...
            payload.put("description", "Credits towards ADVIRAFARM");
            payload.put("method", "upi");
        ...
        razorpay.validateFields(payload, new Razorpay.ValidationListener() {
            ...
            public void onValidationSuccess() {
                try {
                    ...
                    razorpay.submit(payload, PayLaterRazorPayPaymentUPI.this);
                } catch (Exception e) {
            ...
            public void onValidationError(Map<String, String> error) {
                ...
                Toast.makeText(PayLaterRazorPayPaymentUPI.this, "Validation: " + error.get("field") + " " + error.get("description"), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onPaymentSuccess(String razorpayPaymentId, PaymentData paymentData) {
        ...
        //Singleton.getInstance().showShortToast(PayLaterRazorPayPaymentUPI.this, "Payment Successful");//remove toast
...
//in dono me log lgaya kya
        ...
        webview.setVisibility(View.GONE);
        //Toast.makeText(RazorPayPaymentUPI.this, "Error " + Integer.toString(errorCode) + ": " + errorDescription, Toast.LENGTH_SHORT).show();
       ...
       // PaymentDetails("FAILED");
        //Singleton.getInstance().showShortToast(PayLaterRazorPayPaymentUPI.this, "Payment Failed");//remove toast
            ...
            call.enqueue(new Callback<PGPaymentResponse>() {
                ...
                public void onResponse(Call<PGPaymentResponse> call, Response<PGPaymentResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        Intent mainIntent = new Intent(mContext, OrderDetailsActivity.class);
                        mainIntent.putExtra("orderid",adviraorderid);
                        mainIntent.putExtra("from","finish");
                        PayLaterRazorPayPaymentUPI.this.startActivity(mainIntent);
                        finish();
