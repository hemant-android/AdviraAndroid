...
public class RazorPayNoCostEMIBank extends Activity implements PaymentResultWithDataListener {

    private static final String TAG = RazorPayNoCostEMIBank.class.getSimpleName();
    String name = "";
    String cardNumber = "";
    String cvv = "";
    String month = "";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = RazorPayNoCostEMIBank.this;
        try {
                ...
                builder.setMessage("Going back will abort the payment process. Are you sure ?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                RazorPayNoCostEMIBank.this.finish();
    ...
    private void netbankinglist() {
        LayoutInflater.from(RazorPayNoCostEMIBank.this).inflate(R.layout.fragment_method_netbanking_wallet_list, frameLayout, true);
    ...
    private void SubmitEMIDetails(String bankcode) {
        ...
        RazorPayNoCostEMIBank.this.startActivity(mainIntent);
        ...
        razorpay.validateFields(payload, new Razorpay.ValidationListener() {
            ...
            public void onValidationSuccess() {
                try {
                    ...
                    razorpay.submit(payload, RazorPayNoCostEMIBank.this);
                } catch (Exception e) {
            ...
            public void onValidationError(Map<String, String> error) {
                ...
                //Toast.makeText(RazorPayNoCostEMIBank.this, "Validation: " + error.get("field") + " " + error.get("description"), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onPaymentSuccess(String razorpayPaymentId, PaymentData paymentData) {
        ...
        webview.setVisibility(View.GONE);
        //Singleton.getInstance().showShortToast(RazorPayNoCostEMIBank.this, "Payment Successful");//remove toast
    ...
    public void onPaymentError(int errorCode, String errorDescription, PaymentData paymentData) {
        ...
        try {
            ...
            //Singleton.getInstance().showShortToast(mContext, errormessage+"--19");
        ...
        if (errormessage.contains("number is invalid")) {
            ...
            SharedPrefUtil.setPaymentCheck(mContext, SHARED_PREF_PaymentCheck, "retain");
            RazorPayNoCostEMIBank.this.finish();
            //Singleton.getInstance().showErrorLongToast(mContext, errormessage+"--20");
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        if (paystatus.equalsIgnoreCase("FAILED")) {
                           ...
                           // Singleton.getInstance().showShortToast(mContext, "Payment Error");
                            ...
                            {
                                //Singleton.getInstance().showErrorLongToast(mContext, errormessage+"--21");
                            }
                            else
                            {
