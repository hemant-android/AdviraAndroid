...
public class BusinessDetailsActivity extends AppCompatActivity implements IConsts {
    ...
    private String business_typechk = "";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rl_skiplogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent();
                i.setClass(BusinessDetailsActivity.this, MainActivityNav.class);
                startActivity(i);
        ...
        et_fssaiexpiry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(BusinessDetailsActivity.this, android.R.style.Theme_Holo_Dialog,
        ...
        spn_castate.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ...
                    arrayAdapterCity = new CityAdapter(BusinessDetailsActivity.this, R.layout.layout_profile, R.id.profile_name, arrayListCity);
    ...
    private void initUI() {
        mContext = BusinessDetailsActivity.this;
            ...
            call.enqueue(new Callback<MasterResponse>() {
                ...
                public void onResponse(Call<MasterResponse> call, Response<MasterResponse> response) {
                    ...
                    if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                        ...
                        arrayAdapterState = new StateAdapter(BusinessDetailsActivity.this, R.layout.layout_profile, R.id.profile_name, arrayListState);
                      ...
                      /*  List<Profiletype> profiletypeList = new ArrayList<>();
                        profiletypeList = response.body().getMasterData().getProfiletype();


                        arrayListProfiletype = new ArrayList<>();
                        arrayListProfiletype.add(new ProfileTypeList(0, "Select Type of Business "));

                        for (int i = 0; i < profiletypeList.size(); i++) {

                            int profileid = profiletypeList.get(i).getId();
                            String profilename = profiletypeList.get(i).getName();
                            arrayListProfiletype.add(new ProfileTypeList(profileid, profilename));

                        }

                        arrayAdapterProfile = new ProfileAdapter(BusinessDetailsActivity.this, R.layout.layout_profile, R.id.profile_name, arrayListProfiletype);
                        spn_business.setAdapter(arrayAdapterProfile);*/
            ...
            public void onResponse(Call<MeResponse> call, Response<MeResponse> response) {
                ...
                if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                    ...
                    if (response.body().getBusinessProfile().size() > 0) {
                        ...
                        business_typechk = response.body().getEditableFields().get(0).getBusinessInfo().getBusinessType();
                      ...
                      /*  try {
                            for (int i = 0; i < arrayListProfiletype.size(); i++) {
                                if (arrayListProfiletype.get(i).getId() == (Integer.valueOf(response.body().getBusinessProfile().get(0).getBusinessType()))) {
                                    spn_business.setSelection(i);
                                    break;
                                }
                            }
                        } catch (Exception ex) {
    ...
    private void SaveBusinessDetails() {
        ...
        /*int profileid = spn_business.getSelectedItemPosition();
        String profileidd = String.valueOf(arrayListProfiletype.get(profileid).getId());
*/
        String stateid = String.valueOf(arrayListState.get(spn_castate.getSelectedItemPosition()).getId());
        String cityid = "0";
        ...
        //businessProfileRequest.setBusinessType(profileidd);
        ...
        call.enqueue(new Callback<BusinessProfileResponse>() {
            ...
            public void onResponse(Call<BusinessProfileResponse> call, Response<BusinessProfileResponse> response) {
                ...
                if (response.body().getStatus().toString().equalsIgnoreCase("100")) {
                    ...
                    Intent i = new Intent();
                    i.setClass(BusinessDetailsActivity.this, DocumentUploadActivity.class);
                    startActivity(i);
